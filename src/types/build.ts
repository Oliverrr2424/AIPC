...
import type { BuildMarketSummary } from "./market";
...
export interface BuildRequest { budget:number; currency:Currency; country:"Canada"|"US"|"China"; useCase:UseCase; resolution?:"1080p"|"1440p"|"4k"; targetFps?:number; games?:string; aiWorkloads?:string[]; vramPreference?:12|16|24|32; ramCapacityGb?:number; storageCapacityTb?:number; developerWorkloads?:string[]; operatingSystem?:"windows"|"linux"|"none"; preferredCpuBrand?:"intel"|"amd"|"none"; preferredGpuBrand?:"nvidia"|"amd"|"intel"|"none"; preferredColor?:"white"|"black"|"none"; preferredCooling?:"air"|"aio"|"none"; preferredCaseStyle?:"panoramic"|"traditional"|"none"; preferQuiet?:boolean; preferRgb?:boolean; preferSmallFormFactor?:boolean; preferUpgradeability?:boolean; preferLowPower?:boolean; preferValue?:boolean; preferReliability?:boolean; existingPartIds?:string[]; constraints?:InterpretedConstraint[] }
...
export interface BuildRecommendation { id:string; title:string; request:BuildRequest; parts:BuildParts; totalPrice:number; estimatedWattage:number; compatibility:CompatibilityResult[]; performance:PerformanceEstimate; explanation:string; alternatives:AlternativePart[]; generatedAt:string; market?:BuildMarketSummary }
